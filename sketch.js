...
var brokenboat_SpriteData, brokenboat_SpriteSheet
var cannonExplode,backgroundMusic,cannonWater,pirateLaugh
...
function draw() {
  ...
  for (var i = 0; i < balls.length; i++) {
    ...
    for(var c = 0; c < boats.length; c++) {
      if(balls[i]!==undefined && boats[c]!==undefined){
        var collision = Matter.SAT.collides(balls[i].body,boats[c].body)
